...
import classification_model.dsets
...
class ClassificationTrainingApp:
    ...
    def initModel(self):
        model_cls = getattr(classification_model.model, self.cli_args.model)
        model = model_cls()
    ...
    def initTrainDl(self):
        ds_cls = getattr(classification_model.dsets, self.cli_args.dataset)
    ...
    def computeBatchLoss(self, batch_ndx, batch_tup, batch_size, metrics_g,
        ...
        if augment:
            input_g = classification_model.model.augment3d(input_g)
